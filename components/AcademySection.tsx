      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="w-full lg:w-1/2 space-y-6 md:space-y-8">
            ...
            <div className="pt-4">
              <a href="#horarios" className="inline-flex items-center text-primary font-bold hover:text-red-700 transition-colors group text-lg">
          ...
          <div className="w-full lg:w-1/2 mt-6 lg:mt-0">
            <div className="grid grid-cols-2 gap-3 md:gap-4">
              <img 
                className="w-full h-40 md:h-64 object-cover rounded-xl md:rounded-2xl shadow-lg transform translate-y-4 md:translate-y-8" 
              ...
              />
              <img 
                className="w-full h-40 md:h-64 object-cover rounded-xl md:rounded-2xl shadow-lg" 
